...
<html lang="en">
    <head>
        ...
        <title>{{$title}} -  Audio Playlist</title>
    ...
    <body> 
        ...
        <div id="hap-playlist-list">
            ...
            <div id="playlist-audio1">
               @foreach($tags as $tag)
                <div class="hap-playlist-item" data-type="audio" data-mp3="{{url($download_path.$tag->time_folder.$tag->slug)}}"  data-artist="{{$tag->artist}}" data-title="{{$tag->title}}" data-thumb="{{$tag->cover_art}}" data-share="{{url('playlist-embed?slug='.$tag->slug)}}"></div>
                @endforeach
            </div> 
...
<html lang="en">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>{{$title}} - Audio Player</title>
    ...
    <div class="video-holder centered">
        ...
        <div class="playlist-components">
            ...
            <div class="button-holder" style="background:#4f4f4f">
...
(function(){
  var videos = [
    ...
    {
      src : [
        '{{url($download_path.$tag->time_folder.$tag->slug)}}'
      ],
      poster : '',
      title : '{{$tag->title}}'
    },
