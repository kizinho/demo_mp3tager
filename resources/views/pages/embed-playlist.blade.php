...
<html lang="en">
    ...
    >
   @foreach($tags as $tag)
    <source src="{{url($download_path.$tag->time_folder.$tag->slug)}}" type="video/webm" title="{{$tag->title}}" data-poster="">
    <source src="{{url($download_path.$tag->time_folder.$tag->slug)}}" type="video/mp4" title="{{$tag->title}}" data-poster="">
    <source src="{{url($download_path.$tag->time_folder.$tag->slug)}}"  type="video/mkv" title="{{$tag->title}}" data-poster="">
 @endforeach
