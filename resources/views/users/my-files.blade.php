                ...
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <div class="media px-3 py-2 border-bottom ">
                            ...
                            <li class="fa fa-download" style="font-size: 18px; margin-top: 14px;"> {{App\Http\Controllers\Converter::number_format_short(intval($t->downloads))}}</li>&nbsp;&nbsp;
                            <li class="fa fa-chart-bar" style="font-size: 18px; margin-top: 14px;"></li>
                        </div>
                        @endforeach
                        <br/>
